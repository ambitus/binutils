...
enum
{
  ...
  op_tbegin= 0xe560,
  op_tbeginc=0xe561,
  op1_exrl = 0xc6,   op2_exrl = 0x0,
  op1_brcth= 0xcc,   op2_brcth= 0x6,
  op1_bic  = 0xe3,   op2_bic  = 0x47,
  op1_cgrj = 0xec,   op2_cgrj = 0x64,
  op1_clgrj= 0xec,   op2_clgrj= 0x65,
  op1_crj  = 0xec,   op2_crj  = 0x76,
  op1_clrj = 0xec,   op2_clrj = 0x77,
  op1_cgij = 0xec,   op2_cgij = 0x7c,
  op1_clgij= 0xec,   op2_clgij= 0x7d,
  op1_cij  = 0xec,   op2_cij  = 0x7e,
  op1_clij = 0xec,   op2_clij = 0x7f,
  op1_cgrb = 0xec,   op2_cgrb = 0xe4,
  op1_clgrb= 0xec,   op2_clgrb= 0xe5,
  op1_crb  = 0xec,   op2_crb  = 0xf6,
  op1_clrb = 0xec,   op2_clrb = 0xf7,
  op1_cgib = 0xec,   op2_cgib = 0xfc,
  op1_clgib= 0xec,   op2_clgib= 0xfd,
  op1_cib  = 0xec,   op2_cib  = 0xfe,
  op1_clib = 0xec,   op2_clib = 0xff,
};
